...
bigh_reco_pt = mycoffea["BuToKMuMu_fit_pt"].rebin("fit_pt", coarse_reco_pt_axis)
bigh_truth_pt = mycoffea["TruthBuToKMuMu_pt"].rebin("pt", coarse_truth_pt_axis)
...
for trigger in triggers:
	h_truth_pt = bigh_truth_pt.integrate("dataset", ["Bu2KJpsi2KMuMu_probefilter"])
...
# MC probefilter efficiency
bigh_probefilter   = bigh_truth_pt.integrate("dataset", ["Bu2KJpsi2KMuMu_inclusive"])
...
for trigger in triggers:
	h_truth_pt = bigh_truth_pt.integrate("dataset", ["Bu2KJpsi2KMuMu_inclusive"])
...
for trigger in triggers:
	for side in ["tag", "probe"]:
		...
		fig.savefig(f"{figure_directory}/total_efficiency_Bu_{side}_{trigger}.png")
