...
#  drStyle.SetFrameLineWidth(1.5)
  ...
  tdrStyle.SetPadBottomMargin(0.3)
  ...
  tdrStyle.SetTitleW(0.8) # Set the position of the title box
  ...
  tdrStyle.SetLabelOffset(0.025, "XYZ")
  tdrStyle.SetLabelSize(35, "XYZ")
