...
class ttree_accumulator(AccumulatorABC):
    '''An TTree accumulator based on column_accumulator
    ...
    '''
    def __init__(self, tree_name="tree", file_name="tree.root", branches={}):
        self._file = uproot.recreate(file_name)
        self._file[tree_name] = uproot.newtree(branches)
